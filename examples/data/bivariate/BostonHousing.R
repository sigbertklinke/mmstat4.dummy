...
hist(x, freq=FALSE, ylim=c(-0.015, 0.07), col="gray", xlab="Anteil der Unterschichtbevoelkerung pro Bezirk (in %)", ylab="Dichte",  main="Dotplot, Histogramm und Kerndichteschaetzer", bg="transparent")
...
legend("topright", legend=c("h=1,5", "h=1,0", "h=0,5"), col=c("red", "blue", "green"),
       lwd=2, lty=1, title="Kerndichteschaetzer")
dev.off()